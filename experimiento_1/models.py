...
MONEY_DECISION_CHOICES = [
    ...
    (1, 'Usted podrá guardar una parte de su pago y por cada $100 que decida guardar'
        ' nosotros le daremos ${price_session} más. Podrá recibir en esta sesión una parte de su '
        'pago y el monto guardado solo podrá recibirlo al finalizar la tercera sesión.'),
    (2, 'Usted podrá guardar la totalidad de su pago y recibirlo al finalizar la tercera sesión. '
